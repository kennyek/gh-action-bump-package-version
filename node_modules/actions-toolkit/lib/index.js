...
var Toolkit = /** @class */ (function () {
    ...
    Toolkit.prototype.getPackageJSON = function () {
        ...
        var altWorkspace = this.workspace.split('/');
        altWorkspace.pop();
        altWorkspace = '/' + altWorkspace.join('/');
        var altPathToPackage = path_1.default.join(altWorkspace, 'package.json');

        if (fs_1.default.existsSync(pathToPackage)) {
            return require(pathToPackage);
        } else if (fs_1.default.existsSync(altPathToPackage)) {
            return require(altPathToPackage);
        } else {
            console.log(this.workspace);
            console.log(pathToPackage);

            console.log(altWorkspace);
            console.log(altPathToPackage);
